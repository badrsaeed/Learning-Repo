...
namespace StratgyPattern.Business.Models
{
    public class Order
    {
        ...
        public void FinalizeOrder(IInvoiceStrategy? invoiceStrategy = default)
        {
        ...
        public decimal GetTax(ISalesTaxStrategy? strategy = default)
        {
